...
async def get_conversational_answer(retriever, user_input, chat_history):
    ...
    # Configure ChatOllama to use the Ollama API on port 11435
    llm = ChatOllama(model="qwq", base_url="http://localhost:11434")
...
def main():
    ...
    embed_model = OllamaEmbeddings(model='mxbai-embed-large', base_url="http://localhost:11434")
